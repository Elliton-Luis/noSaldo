    ...
    <dialog id="goal_modal" class="modal backdrop:bg-black/70 backdrop-blur-sm" wire:ignore.self>
        <div class="p-6 sm:p-8 bg-stone-900 border border-stone-700 rounded-2xl w-full max-w-md">
            ...
            <div class="flex flex-col items-center gap-4 my-6">
                ...
                <button type="button" class="px-4 py-2 bg-stone-700 hover:bg-stone-600 text-stone-200 text-sm font-semibold rounded-md transition-colors">
                    Escolher Ícone
                </button>
            </div>
            ...
            <form class="space-y-4">
                <div>
                    ...
                    <input type="text" id="goal_name" name="goal_name" placeholder="Ex: Fundo de Emergência"
                           class="w-full p-3 bg-stone-800 border border-stone-700 rounded-md text-stone-200 placeholder-stone-500
                                  focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition" wire:model.lazy="name"/>
                </div>
                ...
                <div>
                    ...
                    <input type="date" id="goal_date" name="goal_date"
                           class="w-full p-3 bg-stone-800 border border-stone-700 rounded-md text-stone-200
                                  focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition" wire:model.lazy="deadline"/>
                </div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="goal_value" name="goal_value" placeholder="10.000,00"
                               class="w-full p-3 pl-10 bg-stone-800 border border-stone-700 rounded-md text-stone-200 placeholder-stone-500
                                      focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent transition" wire:model.lazy="value"/>
                    </div>
                </div>
                ...
                <div>
                    <label for="goal_priority" class="flex justify-between text-sm font-medium text-stone-400 mb-2">
                        ...
                        <span class="font-bold text-amber-400">{{$priority ?? 5}}</span>
                    </label>
                    <input type="range" id="goal_priority" name="goal_priority" min="1" max="10"
                           class="w-full h-2 bg-stone-700 rounded-lg appearance-none cursor-pointer accent-amber-500" wire:model.lazy="priority"/>
                </div>

                <div class="flex items-center gap-3 pt-4">
                    <button type="button" class="w-full py-3 font-semibold text-white bg-amber-600 hover:bg-amber-500 rounded-md transition-colors" wire:click="createGoal()">
                        Salvar Meta
                    </button>
