<dialog id="add_money" class="modal backdrop:bg-black/70 backdrop-blur-sm">
        ...
        <form class="space-y-4">
            <div>
                ...
                <div class="relative">
                    ...
                    <input type="number" wire:model.lazy="value" step="0.01" id="valorInput" name="valorInput" placeholder="99,99"
            ...
            <div class="flex items-center gap-3 pt-4">
                <button type="button"
                    ...
                    onclick="document.getElementById('add_money').close()">
                    Cancelar
                </button>
                <button type="submit"
