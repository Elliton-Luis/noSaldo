            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                @foreach ($incomes as $income)
                    ...
                    <div class="group flex flex-col justify-between rounded-2xl bg-stone-950/50 p-5 shadow-lg
                                ...
                                hover:scale-[1.03] hover:border-emerald-600/70 hover:shadow-2xl hover:shadow-emerald-600/20
                                aspect-[2/1]">
                        <div>
                            <h2 class="text-lg font-bold text-stone-100 mb-2 transition-colors duration-300 group-hover:text-emerald-300">
                                {{ $income->description }}
                            </h2>
